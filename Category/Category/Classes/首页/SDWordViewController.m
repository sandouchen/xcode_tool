...
@interface SDWordViewController ()
@property (nonatomic, strong) NSMutableArray *topics;
@property (nonatomic, assign) NSInteger page;
@property (nonatomic, copy) NSString *maxtime;
@end

@implementation SDWordViewController
...
- (void)loadNewTopics {
    ...
    [SDHTTPRequest newListWithList:@"list" withPage:0 withType:29 withMaxtime:nil success:^(id responseObject) {
...
- (void)loadMoreTopics {
    ...
    [SDHTTPRequest newListWithList:@"list" withPage:self.page withType:29 withMaxtime:self.maxtime success:^(id responseObject) {
        self.maxtime = responseObject[@"info"][@"maxtime"];
